defmodule Games do
  ...
  def start_game do
    answer = GuessingGame.generate_number()
    IO.puts(answer)
    guess = IO.gets("Guess a number from 1 to 10. You have 5 attempts: \n")
    GuessingGame.accept_guess(guess, answer)
  end
end
